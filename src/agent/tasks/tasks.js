...
import { Blueprint, ConstructionTaskValidator } from "./construction_tasks.js";
	...
	try {
		...
		if (
			...
			if (agentId === 0 || agentId === 1) {
				...
				const progress = hellsKitchenProgressManager.updateAgentProgress(data.task_id, agentId, agentResult.success);
