...
import { getCommand, getCommandDocs } from "../agent/commands/index.js";
import { SkillLibrary } from "../agent/library/skill_library.js";
import settings from "../agent/settings.js";
import { Examples } from "../utils/examples.js";
import { stringifyTurns } from "../utils/text.js";
import { createModel, selectAPI } from "./_model_map.js";
	...
	async replaceStrings(prompt, messages, examples = null, to_summarize = [], last_goals = null) {
		...
		if (prompt.includes("$CODE_DOCS")) {
			const code_task_content =
				messages
					.slice()
					.reverse()
					.find((msg) => msg.role !== "system" && msg.content.includes("!newAction("))
		...
		if (prompt.includes("$LAST_GOALS")) {
			...
			for (let goal in last_goals) {
				if (last_goals[goal]) goal_text += `You recently successfully completed the goal ${goal}.\n`;
